    ...
    return (
        <section className="container mx-auto flex justify-center items-center">
            <form
                ...
                className="flex flex-col gap-8 m-12 w-96 bg-zinc-100 p-12 rounded-md">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    {errors.email && errors.email.type == "minLength" && (
                        <div className="text-rose-500 text-sm">تعداد کاراکتر های ایمیل کم است</div>
                    )
                    }
                ...
                <div className="flex flex-col gap-1">
                    ...
                    {errors.rePassword && errors.rePassword.type == "validate" && (
                        <div className="text-rose-500 text-sm">تکرار رمز عبور شما مطابقت ندارد</div>
                    )}
