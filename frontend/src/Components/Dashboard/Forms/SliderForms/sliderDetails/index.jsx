...
const SliderDetails = ({ midBanId }) => {
   ...
   const updater = (e) => {
      ...
      const url = `https://myshop-server.iran.liara.run/api/update-slider/${midBanId}`;
      axios
         .post(url, formData)
         .then((d) => {
   ...
   useEffect(() => {
      axios
         .get(
            `https://myshop-server.iran.liara.run/api/get-slider/${midBanId}`
         )
         .then((d) => {
            setfullData(d.data);
         })
   ...
   const remover = () => {
      const url = `https://myshop-server.iran.liara.run/api/delete-slider/${midBanId}`;
      axios
         .post(url)
         .then((d) => {
